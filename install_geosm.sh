...
sed -i 's/url_backend/'${new_url_backend,,}'/g' environment.ts
sed -i 's/url_frontend/'${new_url_frontend,,}'/g' environment.ts
echo "====== Nom de l'instance ======"
read new_nom_instance
sed -i 's/nom_instance/'${new_nom_instance^^}'/g' environment.ts
sed -i 's/langue/'${lang}'/g' environment.ts

echo "====== Url du drapeau en png ======"
read new_url_drapeau
sed -i 's/url_drapeau/'${new_url_drapeau}'/g' environment.ts
...
sed -i 's/port/'${new_port_frontend}'/g' "${new_url_frontend,,}.conf"
...
sed -i 's/port/'${new_port_backend}'/g' "${new_url_backend,,}.conf"
